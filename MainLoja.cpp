                                      ...
                                      total_itens(new QLabel)
{
    ...
    ui->table_livros->setHorizontalHeaderLabels(QStringList() << "NOME"
                                                              << "PRECO"
                                                              << "AUTOR");
    ...
    ui->table_cds->setHorizontalHeaderLabels(QStringList() << "NOME"
                                                           << "PRECO"
                                                           << "N FAIXAS");
    ...
    ui->table_dvds->setHorizontalHeaderLabels(QStringList() << "NOME"
                                                            << "PRECO"
                                                            << "DURACAO");
